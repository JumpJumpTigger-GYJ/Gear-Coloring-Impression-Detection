...
#MyModel_v3
_C.MODEL.DCT_VIT = CN()
_C.MODEL.DCT_VIT.IN_CHANS = 3
_C.MODEL.DCT_VIT.DIMS = [96, 192, 384, 768]
_C.MODEL.DCT_VIT.DEPTHS = [1, 1, 3, 1]
_C.MODEL.DCT_VIT.SP_WIN_SIZE = [7, 7, 7, 7]
_C.MODEL.DCT_VIT.SP_NUM_HEADS = [3, 6, 12, 24]
_C.MODEL.DCT_VIT.CH_WIN_SIZE = [[7, 14, 28, 56], [7, 14, 28], [7, 14], [7]]
_C.MODEL.DCT_VIT.CH_NUM_HEADS = [4, 6, 8, 16]
_C.MODEL.DCT_VIT.DROP_PATH_RATE = 0.2
